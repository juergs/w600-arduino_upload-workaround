...
Under Windows 10 "%ProgramFiles(x86)%\Arduino" must be set writable, because various files are written to the \Arduino-Directory 
during compile and upload (bad programming!).
